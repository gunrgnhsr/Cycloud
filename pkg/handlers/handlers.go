...
import (
 ...
 "github.com/gunrgnhsr/CycloudServer/models"
)
...
func GetResource(w http.ResponseWriter, r *http.Request) {
 // TODO: Get resource ID from request parameters
 ...
 var resource models.Resource
 err := db.QueryRow("SELECT * FROM resources WHERE id = $1", resourceID).Scan(&resource.ID, &resource.SupplierID, &resource.CPUCores, &resource.Memory, &resource.Storage, &resource.GPU, &resource.Bandwidth, &resource.CostPerHour)
 if err != nil {
